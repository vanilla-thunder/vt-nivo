...
$aLang = array(
	...
	'SHOP_MODULE_GROUP_nivoModuleSettings'      => '<style type="text/css">.groupExp a.rc b {font-size: medium; color: #ff3600; }.groupExp dt input.txt { width: 400px !important} .groupExp dl { display: block !important; } input.confinput {position: fixed; top: 20px; right: 70px; background: #008B2D; padding: 5px 20px; color: white; border: 1px solid black; cursor:pointer; font-size: 125%; } input.confinput:hover {outline: 3px solid #ff3600;}</style>Slider auf folgenden Seiten anzeigen:',
		...
		'SHOP_MODULE_nivoSlices'                    => 'für Slice-Animation: Anzahl der Slices',
		'SHOP_MODULE_nivoBoxCols'                   => 'für Kasten-Animation: Anzahl der Spalten',
		'SHOP_MODULE_nivoBoxRows'                   => 'für Kasten-Animation: Anzahl der Reihen',
		'SHOP_MODULE_nivoAnimSpeec'                 => 'Animationsgeschwindigkeit (ms)',
		'SHOP_MODULE_nivePauseTime'                 => 'Zeit bis zum nächsten Slide (ms)',
		'SHOP_MODULE_nivoStartSlide'                => 'Startslide',

		'SHOP_MODULE_nivoDirectionNav'              => 'Vor-Zurück Navigation anzeigen',
		...
		'SHOP_MODULE_nivoRandomStart'               => 'Zufälliger Start',

		'SHOP_MODULE_nivoBeforeChange'              => 'Funktion beforeChange()',
		'SHOP_MODULE_nivoAfterChange'               => 'Funktion afterChange()',
		'SHOP_MODULE_nivoSlideshowEnd'              => 'Funktion slideshowEnd()',
		'SHOP_MODULE_nivoLastSlide'                 => 'Funktion lastSlide()',
		'SHOP_MODULE_nivoAfterLoad'                 => 'Funktion aterLoad()',
	);